...
export class OutletCustomerController {
  constructor(
    private outletCustomerService: OutletCustomerService,
  ...
  async getNearbyOutlet(
    @Query() nearbyOutletDto: NearbyOutletDto,
  ...
  async getServiceDetails(
    ...
    return this.outletCustomerService.getServiceByServiceAndOutletId(
      outletId,
      serviceId,
      customer,
    );
